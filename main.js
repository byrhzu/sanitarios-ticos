(function () {
  ...
  function initForm() {
    ...
    function readValues() {
      ...
      return {
        ...
        // busca la tabla de tarifas. Confundirlos hacía que Víctor se
    ...
    function ofrecerCotizacion(v) {
      ...
      boton.textContent = "Seguir con Víctor";
  ...
  function initAsistente() {
    ...
    // Convierte lo que Víctor escribe en los mismos enlaces que ya
    ...
    function saludarSiHaceFalta() {
      if (yaSaludo) return;
      yaSaludo = true;
      agregarMensaje("¡Pura vida! Soy Víctor, el asistente virtual de Sanitarios Ticos. Con toda la pata le ayudo con dudas sobre nuestros servicios, cobertura y cómo pedir una cotización.", false);
    }
    ...
    function mandarPregunta(pregunta) {
      ...
      // si Víctor falla o tarda, el camino a una persona ya está ahí.
      ...
      fetch("/api/asistente", {
        ...
        .then(function (d) {
          ...
          // Cuando alguien pide una cotización conversando, Víctor cierra
    ...
    /* -------- Cotizador ---------------------------------------------
       Víctor conversa, pero el precio NO lo inventa él: estas preguntas
       ...
       Víctor, o el formulario de contacto— y las tres terminan en la
    ...
    function siguientePaso() {
      ...
      // la dirección, y Víctor sólo pida lo que falta para el precio.
      ...
      if (paso.tipo === "texto") {
        ...
        esperando = function recibir(valor) {
          ...
          /* La gente contesta con frases —"escríbame al 8888-8888"— y
             ...
             saca el dato; si no se puede, Víctor lo dice y pregunta otra
    ...
    /* Antes de mandar nada, Víctor repite lo que entendió. Es el paso que
    ...
    /* `desdeChat` es cuando la persona lo pidió conversando: ahí Víctor ya
    ...
    /* Tercera puerta de entrada: el formulario de contacto. Manda lo que
       ya recogió y Víctor continúa desde ahí. Va por evento y no por
